...
func Test_ApplyProfiles(t *testing.T) {
	...
	assert.DeepEqual(
		t,
		p.ServiceNames(),
		[]string{"service_1", "service_2", "service_4", "service_5", "service_6"},
	)
...
func Test_ForServices(t *testing.T) {
	...
	assert.DeepEqual(
		t,
		p.DisabledServiceNames(),
		[]string{"service_3", "service_4", "service_5", "service_6"},
	)
	...
	assert.DeepEqual(
		t,
		p.DisabledServiceNames(),
		[]string{"service_1", "service_2", "service_3", "service_4", "service_5"},
	)
}
...
func TestWithServices(t *testing.T) {
	...
	assert.Check(
		t,
		utils.ArrayContains(seen, []string{"service_3", "service_4", "service_2", "service_1"}),
	)
