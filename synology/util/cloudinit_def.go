...
// 	if err != nil {
// 		log.Infof("error while removing tmp directory holding the ISO file: %s", err)
// 	}
...
// 	log.Info("Creating ISO contents")
...
// // libvirt.
// func newCloudInitDefFromRemoteISO(_ context.Context, virConn *synology.Client, id string) (defCloudInit, error) {
// 	ci := defCloudInit{}
...
// 		}
// 	}
// 	log.Infof("[DEBUG]: Read cloud-init from file: %+v", ci)
// 	return nil
// }
...
// 	log.Infof("ISO reader: processing file %s", file.Name())
...
// 	log.Infof("%d bytes downloaded", bytesCopied)
